  ...
  return (
    <Card sx={{ maxWidth: 380, marginTop: 10, boxShadow: 4 }}>
      <CardHeader
        ...
        subheader={new Date(event.startDate).toLocaleDateString("en-US", {year: "numeric",month: "long",day: "numeric",})}
      />
      ...
      <CardContent>
        ...
        <Typography sx={{ fontSize: "13px" ,textAlign: "left",paddingBottom: "20px", marginLeft: "10px", marginTop: "10px"  }}>
        ...
        <Stack direction="row" spacing={0.1} sx={{marginTop: -2}}>
          ...
          <Chip
            label="S"
            sx={{
              ...(new Date(event.startDate).getDay() === 7
                ? { background: green[200] }
                : {}),
            }}
            variant="outlined"
